...
public class CommandStepdefs {
    private Administrator admin = new Administrator("TestAdmin", ProxyAccess.md5("test123"));
    private Clerk clerk = new Clerk("TestClerk", ProxyAccess.md5("123456"));
    private ProxyAccess proxy = new ProxyAccess(new RealAccess());
